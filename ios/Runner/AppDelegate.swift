...
@objc class AppDelegate: FlutterAppDelegate, CLLocationManagerDelegate {
    ...
    override func application(
        ...
        let bubbleChannel = FlutterMethodChannel(name: "package:motoboy/floating_bubble", binaryMessenger: controller.binaryMessenger)
        ...
        let ringtoneChannel = FlutterMethodChannel(name: "package:motoboy/ringtone", binaryMessenger: controller.binaryMessenger)
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        let channel = FlutterMethodChannel(name: "package:motoboy/floating_bubble", binaryMessenger: (window?.rootViewController as! FlutterViewController).binaryMessenger)
